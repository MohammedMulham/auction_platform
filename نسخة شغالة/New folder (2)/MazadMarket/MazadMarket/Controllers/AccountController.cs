...
namespace MazadMarket.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            //model.Roles = "4da3621d-85d1-4edd-b3f7-e531dbba909e";for admin
            model.Roles = "Admin";
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser { UserName = model.userName, Email = model.Email , fullName = model.fullName , PhoneNumber = model.PhoneNumber,
                                                    address = model.address, bankCardNumber = model.bankCardNumber};
                ...
                if (result.Succeeded)
                {
                    ...
                    //await this.UserManager.AddToRoleAsync(user.Id, model.fullName);
